...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloUserName()).thenReturn("leszekpogorzelski");
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI url = new URI("http://test.com/members/leszekpogorzelski/boards?key=test&token=test&fields=name,id&lists=all");
